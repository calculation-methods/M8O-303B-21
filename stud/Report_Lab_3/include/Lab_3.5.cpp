...
int main() {
    ...
    double y0 = 0.75, y1 = pow(exp(1),2)*(exp(1)+2)/pow((exp(1)+2),2);
    ...
    for (int i = 0; i <= N; ++i)
        cout << shooting_method_result[i] << "\t";
    cout << endl;

    cout << "Finite_difference_method:"<< endl;
    for (int i = 0; i <= N; ++i)
        cout << finite_difference_method_result[i] << "\t";
    cout << endl << endl;

    cout << "With Runge-Romberg-Richardson:" << endl;
    cout << "Shooting method:"<< endl;
    for (int i = 0; i <= N; ++i)
        cout << shooting[i] << "\t";
    cout << endl;
    ...
    cout << "Finite_difference_method:"<< endl;
    for (int i = 0; i <= N; ++i)
        cout << finite_difference[i] << "\t";
    cout << endl << endl;

    cout << "Difference from accurate value" << endl;
    cout << "Shooting method:"<< endl;
    for (int i = 0; i <= N; ++i)
        cout << abs(shooting[i] - y_exact[i]) << "\t";
    cout << endl;

    cout << "Finite_difference_method:"<< endl;
    for (int i = 0; i <= N; ++i)
        cout << abs(finite_difference[i] - y_exact[i]) << "\t";
    cout << endl;
