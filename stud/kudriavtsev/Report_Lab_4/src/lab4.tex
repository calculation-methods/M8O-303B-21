...
\begin{figure}[h!]
\centering
\includegraphics[width=15cm, height=3cm]{img_1i}
...
\begin{figure}[h!]
\centering
\includegraphics[width=15cm, height=15cm]{img_1}
...
\lstinputlisting{include/Lab_4.1.cpp}
\pagebreak
...
\begin{figure}[h!]
\centering
\includegraphics[width=.9\textwidth]{img_2i}
\caption{Входные данные}
\end{figure}
% \pagebreak
...
\begin{figure}[h!]
\centering
\includegraphics[width=.9\textwidth]{img_2}
\caption{Вывод программы в консоли}
\end{figure}
...
\lstinputlisting{include/Lab_4.2.cpp}
