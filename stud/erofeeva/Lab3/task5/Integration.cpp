...
int main()
{
    ...
    double i1 = integrate_rectangles(f2, -1, 1, h1);
    double i2 = integrate_rectangles(f2, -1, 1, h2);
    fout << "при h1: " << i1;
    fout << "\nпри h2: " << i2;
    fout << "\nуточнение Рунге-Ромберга: " << method_runge(i1, i2, h1, h2, 2);
    fout << "\nМетод трапеций:\n";
    i1 = integrate_trapezoids(f2, -1, 1, h1);
    i2 = integrate_trapezoids(f2, -1, 1, h2);
    fout << "при h1: " << i1;
    fout << "\nпри h2: " << i2;
    fout << "\nуточнение Рунге-Ромберга: " << method_runge(i1, i2, h1, h2, 2);
    fout << "\nМетод Симпсона:\n";
    i1 = integrate_simpson(f2, -1, 1, h1);
    i2 = integrate_simpson(f2, -1, 1, h2);
    fout << "при h1: " << i1;
    fout << "\nпри h2: " << i2;
